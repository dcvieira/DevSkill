...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevSkill.Domain.Catalog.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DevSkill.Domain.Catalog.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevSkill.Domain.Order.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevSkill.Domain.Order.Entities.OrderDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevSkill.Domain.Catalog.Entities.Course", b =>
                {
                    b.HasOne("DevSkill.Domain.Catalog.Entities.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("DevSkill.Domain.Order.Entities.OrderDetails", b =>
                {
                    b.HasOne("DevSkill.Domain.Order.Entities.Order", null)
                        .WithOne("OrderDetails")
                        .HasForeignKey("DevSkill.Domain.Order.Entities.OrderDetails", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("DevSkill.Domain.Order.ValueObjects.CreditCardNumber", "CreditCardNumber", b1 =>
                        {
