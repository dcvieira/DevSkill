...
public class BaseCatalogDataService
{
    protected readonly ILocalStorageService _localStorage;

    protected ICatalogClient _client;

    public BaseCatalogDataService(ICatalogClient client, ILocalStorageService localStorage)
    {
        _client = client;
